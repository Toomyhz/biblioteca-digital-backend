...
Revision ID: 423e164445b7
Revises: 
Create Date: 2025-11-29 23:48:55.444254
...
def upgrade():
    ...
    sa.Column('archivo_portada', sa.String(length=255), nullable=True),
    sa.Column('slug_titulo', sa.String(length=300), nullable=False),
