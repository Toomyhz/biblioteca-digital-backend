...
class Libros(db.Model):
    ...
    def to_dict(self, include_autores=True, include_carreras=True):
        ...
        if include_autores:
            data["autores"] = [autor.to_dict(
                include_libros=False) for autor in self.autores]
        if include_carreras:
            data["carreras"] = [carrera.to_dict(
                include_libros=False) for carrera in self.carreras]
        return data
